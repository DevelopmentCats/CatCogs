...
class ConfigManager:
    ...
    async def get_api_key(self) -> Optional[str]:
        """Get API key."""
        return await self._config.get_raw("api_key")
    
    async def set_api_key(self, api_key: str) -> None:
        """Set API key."""
        try:
            await self._config.set_raw("api_key", value=api_key)
        except Exception as e:
            raise ConfigError(f"Failed to set API key: {str(e)}")
    
    async def get_model_name(self) -> str:
        """Get model name."""
        return await self._config.get_raw("model_name")
    
    async def set_model_name(self, model_name: str) -> None:
        """Set model name."""
        try:
            await self._config.set_raw("model_name", value=model_name)
        except Exception as e:
    ...
    async def is_channel_disabled(self, channel_id: int) -> bool:
        ...
        try:
            disabled = await self._config.get_raw("disabled_channels")
    ...
    async def toggle_channel(self, channel_id: int) -> bool:
        ...
        try:
            ...
            if channel_id in disabled:
                ...
                is_disabled = True
            await self._config.set_raw("disabled_channels", value=disabled)
            return is_disabled
        except Exception as e:
    ...
    async def is_server_disabled(self, server_id: int) -> bool:
        ...
        try:
            disabled = await self._config.get_raw("disabled_servers")
    ...
    async def toggle_server(self, server_id: int) -> bool:
        ...
        try:
            ...
            if server_id in disabled:
                ...
                is_disabled = True
            await self._config.set_raw("disabled_servers", value=disabled)
            return is_disabled
        except Exception as e:
    ...
    async def get_max_history(self) -> int:
        ...
        return await self._config.get_raw("max_history")
    ...
    async def set_history_expiry_hours(self, hours: int) -> None:
        ...
        try:
            await self._config.set_raw("history_expiry_hours", value=hours)
        except Exception as e:
    ...
    async def get_rate_limit_config(self) -> Dict[str, int]:
        ...
        try:
            return {
                "requests": await self._config.get_raw("rate_limit_requests"),
                "burst": await self._config.get_raw("rate_limit_burst"),
                "cooldown": await self._config.get_raw("rate_limit_cooldown")
            }
        except Exception as e:
    ...
    async def get_tool_config(self, tool_name: str) -> Dict[str, Any]:
        ...
        try:
            tool_configs = await self._config.get_raw("tool_configs")
